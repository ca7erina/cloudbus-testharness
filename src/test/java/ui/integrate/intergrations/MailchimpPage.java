...
public class MailchimpPage extends BasePage{
	public static String PAGE_URL=CfgLoader.intergrateMailchimpUrl;
	public static String PAGE_TITLE=CfgLoader.intergrateMailchimpPageTitle;
