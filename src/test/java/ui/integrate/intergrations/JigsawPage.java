...
public class JigsawPage extends BasePage{
	public static String PAGE_URL=CfgLoader.intergrateJigsawUrl;
	public static String PAGE_TITLE=CfgLoader.intergrateJigsawPageTitle;
