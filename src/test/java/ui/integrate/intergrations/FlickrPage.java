...
public class FlickrPage extends BasePage {
	public static String PAGE_URL=CfgLoader.intergrateFlickrUrl;
	public static String PAGE_TITLE=CfgLoader.intergrateFlickrPageTitle;
