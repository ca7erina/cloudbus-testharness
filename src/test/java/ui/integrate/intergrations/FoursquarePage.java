...
public class FoursquarePage  extends BasePage{
	public static String PAGE_URL=CfgLoader.intergrateFoursquareUrl;
	public static String PAGE_TITLE=CfgLoader.intergrateFoursquarePageTitle;
