...
public class EvernotePage extends BasePage {
	public static String PAGE_URL=CfgLoader.intergrateEvernoteUrl;
	public static String PAGE_TITLE=CfgLoader.intergrateEvernotePageTitle;
