 ...
 *
 */
public class ContactPage_AfterSignIn extends HomePage {
	public static String PAGE_URL=CfgLoader.contactPageUrl;
	public static String PAGE_TITLE=CfgLoader.contactPageTitle;
	...
	@FindBy(id="#_input_a100")
	private WebElement QUESTION_SELECT; //iframe of contact form
	
	@FindBy(id="_input_a111")
	private WebElement PHONE_INPUT;
	
	private String CURRENT_WINDOW=DriverUtil.getDriver().getWindowHandle();
	
	public ContactPage_AfterSignIn() {
		super();
	}
